  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center gap-2 px-2">
        ...
        <h2 className="font-medium text-lg neon-text-blue">Your Chats</h2>
      </div>
            ...
            <Link key={index} href={'/workspace/' + workspace?._id}>
              ...
              >
                <div className="flex items-start gap-3">
                  <div className="p-1.5 bg-gradient-to-r from-[#1b76ff]/20 to-[#35c5ff]/20 rounded-md group-hover:from-[#1b76ff]/30 group-hover:to-[#35c5ff]/30 transition-all duration-200">
